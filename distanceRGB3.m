...
for i=1:400
    for j=1:400
        ...
        g2 = FV(j,:);
        v = g-g2;
        distance_rgb(i,j) =sqrt(sum((g - g2) .^ 2));% sqrt(v*v');
    end
    i
end
...
for i=1:400
    [B(i,:),I(i,:)] = sort(distance_rgb(i,:),'Ascend');
end
...
result_RGB_400=[avg_pre avg_rec avg_fscore]
save('RGB_400','avg_pre','avg_rec','avg_fscore','distance_rgb')
